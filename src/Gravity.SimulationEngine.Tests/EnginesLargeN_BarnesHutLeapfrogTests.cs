...
namespace Gravity.SimulationEngine.Tests
{
    ...
    public class EnginesLargeNBarnesHutLeapfrogTests : EnginesLargeNBaseTests
    {
        protected override Factory.SimulationEngineType EngineType => Factory.SimulationEngineType.BarnesHutWithLeapfrog;

        [TestMethod]
        [Timeout(60000, CooperativeCancellation = true)]
        public void BarnesHutLeapfrogRun10kEntities1000Steps()
