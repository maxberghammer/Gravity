...
/// </summary>
[CPUUsageDiagnoser]
public class Direct : Base
{
	#region Interface

	[Benchmark]
	public double Bodies1000Steps1000()
		=> Run(Direct, ResourcePaths.ThousandBodiesSimulation, 1000);

	[Benchmark]
	public double Bodies10000Steps100()
		=> Run(Direct, ResourcePaths.TenKBodiesSimulation, 100);

	[Benchmark]
	public double Bodies10000Steps1000()
		=> Run(Direct, ResourcePaths.TenKBodiesSimulation, 1000);
